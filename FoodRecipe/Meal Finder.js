...
const getData = async (value) =>{
    try{
        ...
        document.querySelector(".showMeal").innerHTML="<h1>Meal Recipe Not Founds</h1>"
    }
}
...
searchBtn.addEventListener("click", function(){
    ...
    if(searchValue == ""){
        alert ("Please Search Your Dish For Recipe")
    }
    else{
        getData(searchValue)
    }
...
// Slider Parts (Navigation Right Or Left Buttons)
